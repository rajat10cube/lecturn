# Contributing to Lecturn

Thanks for your interest! Lecturn is a self-hosted course player — point it at a
...
> **License of contributions:** Lecturn is licensed under **AGPL-3.0**. By
...
cp .env.example .env            # set LECTURN_CONFIG or LECTURN_COURSES_DIR
...
- **Don't commit** secrets or generated artifacts — `.env`, `lecturn.yaml`,
...
- relevant logs (`journalctl -u lecturn` for LXC, or the uvicorn console).
...
Thanks for helping make Lecturn better! 🎓
